...
\begin{document}
	...
	\par{\centering{\bf\sffamily\Huge David Beauchemin}\\\vspace{2pt}
		...
		\begin{tabular}{L!{\VRule}R}
			...
			&\\[-6pt]
			2018 -- 2020  &{\bf {Conseiller en IA}}\\
			\multirow{1}{*}{\includegraphics[scale=0.09]{images/Vooban.png} \tab[1.15cm]}& Vooban\\
			& Conseiller technique en transformation numérique en intelligence artificielle
		\end{tabular}
		...
		\begin{tabular}{L!{\VRule}R}
			2024 -- \tab[.7cm]  & \textbf{\href{https://www.cqcm.coop/}{Conseil québécois de la coopération et de la mutualité}} \\
			\multirow{1}{*}{\includegraphics[scale=0.1]{images/Logo-CQCM.png} \tab[1cm]}& Membre du conseil d'administration \\
			& Québec, Canada\\
			&\\
			&\\[-6pt] 
			2023 -- \tab[.7cm]  & \textbf{\href{https://polecn.org/}{Pôle de la Capitale-Nationale}} \\
			\multirow{1}{*}{\includegraphics[scale=0.25]{images/logo-pole-couleur.png} \tab[1cm]}& Trésorier du conseil d'administration \\
			& Québec, Canada\\
			&\\
			&\\[-6pt] 
			2021 -- \tab[.7cm]  & \textbf{\href{https://iid.ulaval.ca//}{Institut Intelligence et Données}} \\
			\multirow{1}{*}{\includegraphics[scale=0.1]{images/iid.png} \tab[1cm]}& Membre du conseil d'administration \\
			& Québec, Canada\\
			&\\
			&\\[-6pt] 
